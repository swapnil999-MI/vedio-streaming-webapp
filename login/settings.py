...
SECRET_KEY = 'django-insecure-79p!^#&5okb5*j$a2@pc^%fd=we*cbg3f4y)*64u(!*y$t-nur'
...
EMAIL_HOST_USER = 'swapniljagadale007@gmail.com'  # Replace with your email username
EMAIL_HOST_PASSWORD = 'ecvbxvjmaqaurpyv'  # Replace with your email password
